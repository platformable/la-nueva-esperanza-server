...
updateProgressNote: async (req, res) => {
  ...
  SupportGroups=$60,
  SupportGroupsDate=$61,
  IDG=$62,
  IDGDate=$63,
  progressNoteText=$64,
  HCWSignature=$65,
  clientUniqueId=$66,
  goal1ProgressComments=$67,
  goal2ProgressComments=$68,
  goal3ProgressComments=$69,
  goal1CompletionComments=$70,
  goal2CompletionComments=$71,
  goal3CompletionComments=$72,
   where progress_note.id=$73`,
      values: [
        clientId,
        clientFirstName,
        clientLastName,
